...
namespace MetaData.Beheer
{
    public class BeheerModuleInitializer : ModuleInitializer
    {
        ...
        protected virtual void RegisterSiteMapInformation(ISiteMapBuilderService siteMapBuilderService)
        {
            ...
            SiteMapNodeInfo beheerCategrieViewNodeDepricated = new SiteMapNodeInfo("CategorieViewDepricated",
                                               "~/Depricated/Categorieen.aspx",
                                               "Categorie Beheer Depricated");
            siteMapBuilderService.AddNode(beheerCategrieViewNodeDepricated, moduleNode);
