...
namespace MetaData.Beheer.Views
{
                                       ...
                                       IBusinessEntityView
    {
        ...
        private void SortView()
        {
            ...
            {
                m_Presenter.OnSortDescending();
            }
            else
            {
                m_Presenter.OnSortAscending();
            }
        }
        #endregion
        ...
        private void SetVisibilityCrudDetail(Label controlFound, GridViewRow row)
        {
            ...
            if (controlFound != null)
            {
                ...
                var editMaster = row.FindControl("BtnEdit") as ImageButton;
                var deleteMaster = row.FindControl("BtnDelete") as ImageButton;
                var insertDetail = row.FindControl("BtnInsertTrefwoord") as ImageButton;
                ...
                {                    
                    ...
                    var insertDetailInline = row.FindControl("BtnInsertInlineTrefwoord") as ImageButton;
