        ...
        <tr>
            <td>
                ...
                <div id="DivButton">
                    ...
                    &nbsp;<pp:ObjectContainerDataSource ID="TrefwoordenTableDatasource" runat="server" DataObjectTypeName="Beheer.BusinessObjects.Dictionary.BeheerContextEntity"
                    ...
                    <asp:GridView ID="TrefwoordView" runat="server" AllowPaging="True" OnPreRender="OnPreRenderGridView"
                        ...
                        <Columns>
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <input id="Button2" type="button" value="Nieuw Trefwoord" class="insertbutton" />
                                        ...
                                        <tr valign="top">
                                            <td>
                                                <asp:ImageButton ID="BtnInsertTrefwoord" runat="server" CommandName="Edit" ImageUrl="~/Images/plus_32.png"
                                                    ToolTip="Voeg een nieuwe trefwoord toe" OnClick="OnPrepareInlineInsert" CssClass="button"/>
                                                <asp:ImageButton ID="BtnInsertInlineTrefwoord" runat="server" CommandName="Edit"
                                                    ...
                                                    ToolTip="Voeg een nieuwe trefwoord toe" CssClass="button" />
                                            </td>
                                            <td>
