...
%NANT_HOME%\NAnt.exe -t:net-3.5 runtest -buildfile:"default.build" -logger:NAnt.Core.DefaultLogger -logfile:DailyBuild-DomeinenTest.log

rem werkt alleen in VS2008
%NANT_HOME%\NAnt.exe -t:net-3.5 report.daily.build -buildfile:"default.build" -logger:NAnt.Core.DefaultLogger -logfile:Report-DomeinenTest.log

copy .\Daily-Build-Report\index.htm ..\Observlet /Y
pause
exit
