...
public void IsTimeToWork785()
{
    Schedule schedule;
    bool b;
    schedule =
      ScheduleFactory.Create(default(TimeSpan), 0, default(DateTime), false);
    b = this.IsTimeToWork(schedule, default(DateTime));
...
public void IsTimeToWork160()
{
    ...
    schedule =
      ScheduleFactory.Create(default(TimeSpan), 0, default(DateTime), false);
    b = this.IsTimeToWork
            (schedule, new DateTime(4611686018427387903L & 3012413748118454272L, 
                                    (DateTimeKind)(3012413748118454272uL >> 62)));
...
public void IsTimeToWorkThrowsOverflowException980()
{
    Schedule schedule;
    bool b;
    TimeSpan s0 = new TimeSpan(-9223301668073897968L);
    schedule = ScheduleFactory.Create(s0, 0, default(DateTime), false);
    b = this.IsTimeToWork
            (schedule, new DateTime(4611686018427387903L & 2940353164697188133L, 
                                    (DateTimeKind)(2940353164697188133uL >> 62)));
}
    }
}
