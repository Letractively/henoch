...
namespace DataResource
{
    ...
    public class MyAccess:IDataConsumer
    {
        ...
        public static LinQToSqlServer.Project Project { get; private set; }
        /// <summary>
                        ...
                        case 0:
                            ...
                            if (createFiles)
                            {
                                ...
                                for (int j = 0; j < countFiles; j++)
                                {
                                    ...
                                    BronBestanden.Add(new DesignPatterns.BronBestand
                                                                        {
                                                                            Naam = shortName,
                                                                            Pad = destFileName
                                                                        });
        ...
        private void CopyBronFile(string shortName, string dirTarget)
        {
            ...
            catch (Exception)
            {
                ...
                Maintenance.Log.Writeline("Negeer de functie CopyBronFile.");
            }
        ...
        {
            ///NOTE: caller must anticipate exception.
            var bronBestand = new LinQToSqlServer.BronBestand();
        ...
        public static void CreateTerugKeerPeriode(IEnumerable prestatiePeilen)
        {
            ...
            foreach (KeyValuePair<string, double> pair in prestatiePeilen)
            {
                ...
                Maintenance.Log.Writeline(line + "\ttoetspeil:\t" + toetspeil);
