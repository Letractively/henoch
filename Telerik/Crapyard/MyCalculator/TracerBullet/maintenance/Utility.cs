...
#pragma warning restore RedundantAssignment
        ...
        /// files are not the same. Use readByteLevel=true to check on bytes, otherwise
        /// check if the line-strings are equal (ignoring carriage-line returns and case).
        /// </summary>
        /// <param name="file1"></param>
        /// <param name="file2"></param>
        /// <param name="readByteLevel"></param>
        /// <param name="errMatrix"></param>
        /// <returns></returns>
        //public static  bool FileCompare(string file1, string file2, bool readByteLevel)
        //{
        //    int file1byte;
        //    int file2byte;
        //    FileStream fs1;
        ...
        //    int fouten = 0;
        //    int lineNumber = 0;
        //    MyCollection errTable = new MyCollection();
        //    try
        //    {
        //        if (readByteLevel)
        //        {
        ...
        //                throw new CheckedException("File lengths are not equal.");
        //            }
        ...
        //            {
        //                throw new CheckedException("Not all bytes are equal.");
        //            }
        //        }
        //        else
        //        {
        //            using (TextReader readFileSsf = new StreamReader(file1),
        //                              readFileSnf = new StreamReader(file2))
        //            {
        //                while (!isEof)
        //                {
        //                    lineFile1 = readFileSsf.ReadLine();
        //                    lineFile2 = readFileSnf.ReadLine();
        //                    lineNumber++;

        //                    if (!string.IsNullOrEmpty(lineFile1) )
        //                    {
        //                        if (!string.IsNullOrEmpty(lineFile2))
        //                        {
        //                            if (!lineFile1.Trim().Equals(lineFile2.Trim(),
        //                                                         StringComparison.InvariantCultureIgnoreCase))
        //                            {
        //                                CompareLines(file1, lineFile1, lineFile2, lineNumber, errTable);

        //                                fouten++;
        //                                //throw new CheckedException("Not all lines are equal:" + lineFile1);
        //                            }
        //                        }
        //                        else
        //                        {
        ...
        //                    {
        //                        //if (fouten > 0)
        //                        //    Log.ConsoleWriteline("fouten: " + fouten);
        //                        ///eof file1
        //                        return string.IsNullOrEmpty(lineFile2);
        //                    }
        //                }
        //            }
        //        }
        ...
        //        Log.ConsoleWriteline("-------------------------------------");
        //        Log.ConsoleWriteline(string.Format(CultureInfo.InvariantCulture, "Reason failure for \n{0} : \n{1}", file1, ex.Message));
        //    }
        //    catch (Exception ex)
        //    {
        //        Log.ConsoleWriteline("");
        //        Log.ConsoleWriteline("-------------------------------------");
        //        Log.ConsoleWriteline("Reason failure:" + ex.Message);
        //        throw;
        //    }
        ...
        //}
        /// <summary>
        /// Compares lines as vectors. returns a table with name and a mismatch-matrix 
        /// </summary>
        /// <param name="file1"></param>
        /// <param name="lineFile1"></param>
        /// <param name="lineFile2"></param>
        /// <param name="fouten"></param>
        /// <param name="errTable"></param>
        //private static void CompareLines(string file1, string lineFile1, string lineFile2, 
        //    int lineNumber, MyCollection errTable)
        //{
        //    ///Use the shared data/singleton:
        //    double precision = InitData.UniqueInstance.Precision;
        //    double[][] errMatrix;
        //    string message = string.Format(CultureInfo.InvariantCulture,
        //                                   "file1={0}\nval1= {1}\nval2= {2}\n",
        //                                   Path.GetFileName(file1), lineFile1, lineFile2);
        //    //Log.ConsoleWriteline(message);  
        //    Vector vector1 = new Vector(lineNumber, lineFile1, ParseFormat.ReadNumbersOnly, " ");
        //    Vector vector2 = new Vector(lineNumber, lineFile2, ParseFormat.ReadNumbersOnly, " ");

        //    ///Debug.Assert(!Path.GetFileName(file1).Equals("scen_sluit_Roompot Buiten.dat"));
        //    vector1.Compare(vector2, precision, out errMatrix);
        //    ///For output:
        //    errTable.Scalars = errMatrix;
        //    errTable.Name = message;
        //    Log.ConsoleWriteline(Path.GetFileName(file1) + "\t");
        //    errMatrix.Dump(errMatrix.Length,4);
        //}
